...
public class C01_Locators {
    public static void main(String[] args) {
        ...
        //should assign the locators on webelement class
        WebElement searchButton = driver.findElement(By.id("gh-btn"));
        // i created locator for the search button on the main page
        // now i can click on the button via this WebElement
        // i can test is this button visible or not
        // If the driver cannot find the object with findElement(),
        // it throws a NoSuchElementException

        // Search Text box on the ebay main page
        WebElement searchTextBox = driver.findElement(By.name("_nkw"));
        //can send test data (text) with locator
